...
var ManufacturersComponent = (function () {
    ...
    ManufacturersComponent.prototype.getManufacturers = function () {
        ...
        this._manufacturerService.getManufacturers()
            .then(function (manufacturers) { return _this.manufacturers = manufacturers; })
    ...
    ManufacturersComponent = __decorate([
        ...
        __metadata('design:paramtypes', [router_deprecated_1.Router, manufacturer_service_1.ManufacturerService])
